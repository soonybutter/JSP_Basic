...
DROP SEQUENCE GROUPNODQ;

CREATE SEQUENCE BOARDNOSQ NOCACHE;
CREATE SEQUENCE GROUPNOSQ NOCACHE;

SELECT * FROM ANSWERBOARD ORDER BY GROUPNO, GROUPSQ;


-- 첫번째 글 작성
 INSERT INTO ANSWERBOARD
 VALUES (BOARDNOSQ. NEXTVAL, GROUPNOSQ. NEXTVAL,
1, 0, '첫번째 글', '1번 글 입니다.', '유저1', CURRENT_DATE);

-- 두번째 글 작성
 INSERT INTO ANSWERBOARD
 VALUES (BOARDNOSQ. NEXTVAL, GROUPNOSQ. NEXTVAL,
1, 0, '두번째 글', '2번 글 입니다.', '유저2',CURRENT_DATE);
...
INSERT INTO ANSWERBOARD
VALUES(BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL,
1,0,'세번째 글','3번 글 입니다아아.','유저3',CURRENT_DATE);
...
-- 부모와 같은 GROUPNO,
-- 부모의 GROUPSQ보다 큰 글 들의 GROUPSQ+1
...
VALUES(BOARDNOSQ.NEXTVAL,
	...
	(SELECT GROUPSQ FROM ANSWERBOARD WHERE BOARDNO=2)+1,
	(SELECT TITLETAB FROM ANSWERBOARD WHERE BOARDNO=2)+2,
	'RE:두번째 글에 답변그을','2번글 답변글!!','유저2',CURRENT_DATE
);
