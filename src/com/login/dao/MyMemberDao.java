...
public class MyMemberDao {
	...
	public List<MyMemberDto> selectAll(){
		...
		PreparedStatement pstm = null;
		ResultSet rs = null;
		List<MyMemberDto> res = new ArrayList<MyMemberDto>(); //결과 옮겨담을 리스트 만듦.
	...
	public int insertUser(MyMemberDto dto) {
		...
		//VALUES(SEQ_MYMEMBER.NEXTVAL, 'ADMIN','1234','관리자','관리시 관리구 관리동','010-1234-5678',
		...
		try {
			...
			res = pstm.executeUpdate();
			System.out.println("05. query 실행 및 리턴");
	...
	public int deleteUser(int myno) {
		//3. db에 저장된 회원 탈퇴
		String sql =" UPDATE MYMEMBER SET MYENABLE='N' "+
					" WHERE MYNO=? ";
